...
// ===== SPRITE GRAPHICS (Caves of Qlud) =====
// ============================================================
//  PALETTE  — single-char keys for compact pixel data
...
// ============================================================
//  BOSSES — 4 representative archetypes
// ============================================================
const SP_BOSS_RATKING = S(`
................
.......KK.......
......KLWK......
.....KKWLKK.....
...
// ============================================================
//  ACT II SPRITES — v0.15.0
//  Player v2 (geared), 7 revamped + 7 new commons, 20 new bosses,
//  4 new biome tilesets (Sunken Reliquary, Ashen Wastes, Verdant Rot,
//  Citadel of Stars). Same palette as Act I.
//  Note: Citadel tile consts use TILE_CIT_* and the Hollow Choir
//  boss uses SP_BOSS_HOLLOWCHOIR to avoid colliding with Act I's
//  Crypt (TILE_C_*) and Hollow Knight (SP_BOSS_HOLLOW).
// ============================================================

const SP_PLAYER_V2 = S(`
................
......KLLK......
.....KKLLKK.....
....KCiiiiCK....
...
const SPRITE_LINES = {
  ...
  wall:TILE_D_WALL, floor:TILE_D_FLOOR, stairs_down:TILE_D_STAIRS_DOWN, stairs_up:TILE_D_STAIRS_UP,
  // biome 1: Dungeon Halls
  d_wall:TILE_D_WALL, d_floor:TILE_D_FLOOR, d_stairs_down:TILE_D_STAIRS_DOWN, d_stairs_up:TILE_D_STAIRS_UP,
  // biome 2: Bone Crypt
  c_wall:TILE_C_WALL, c_floor:TILE_C_FLOOR, c_bones:TILE_C_BONES,
  // biome 3: Damp Caverns
  k_wall:TILE_K_WALL, k_floor:TILE_K_FLOOR, k_shroom:TILE_K_SHROOM, k_rocks:TILE_K_ROCKS,
  // biome 4: Infernal Depths
  h_wall:TILE_H_WALL, h_floor:TILE_H_FLOOR, h_brazier:TILE_H_BRAZIER,
  // Act II biome 5: The Sunken Reliquary (teal marble + flooded floor)
  r_wall:TILE_R_WALL, r_floor:TILE_R_FLOOR, r_shrine:TILE_R_SHRINE, r_coins:TILE_R_COINS,
  // Act II biome 6: The Ashen Wastes (burnt stone + soot floor)
  a_wall:TILE_A_WALL, a_floor:TILE_A_FLOOR, a_embers:TILE_A_EMBERS, a_skull:TILE_A_SKULL,
  // Act II biome 7: The Verdant Rot (vine walls + mossy earth)
  v_wall:TILE_V_WALL, v_floor:TILE_V_FLOOR, v_corpse:TILE_V_CORPSE, v_fungus:TILE_V_FUNGUS,
  // Act II biome 8: The Citadel of Stars (obsidian + onyx). 'cit_' prefix to avoid the crypt's 'c_wall'.
  cit_wall:TILE_CIT_WALL, cit_floor:TILE_CIT_FLOOR, cit_crystal:TILE_CIT_CRYSTAL, cit_starfield:TILE_CIT_STARFIELD,
  player:SP_PLAYER, player_v2:SP_PLAYER_V2,
  rat:SP_RAT, goblin:SP_GOBLIN, archer:SP_ARCHER, orc:SP_ORC, troll:SP_TROLL, mage:SP_MAGE, mimic:SP_MIMIC,
  // Act II revamped basics (same archetypes, fiercer art). Drop-in art, not wired yet.
  rat_v2:SP_RAT_V2, goblin_v2:SP_GOBLIN_V2, archer_v2:SP_ARCHER_V2, orc_v2:SP_ORC_V2,
  troll_v2:SP_TROLL_V2, mage_v2:SP_MAGE_V2, mimic_v2:SP_MIMIC_V2,
  // Act II new commons
  wraith:SP_WRAITH, hound:SP_HOUND, spitter:SP_SPITTER, glasshusk:SP_GLASSHUSK,
  cinderling:SP_CINDERLING, brine:SP_BRINE, boneknight:SP_BONEKNIGHT,
  chest:SP_CHEST, merchant:SP_MERCHANT,
  boss_ratking:SP_BOSS_RATKING, boss_warlord:SP_BOSS_WARLORD, boss_widow:SP_BOSS_WIDOW, boss_dragon:SP_BOSS_DRAGON,
  boss_ogre:SP_BOSS_OGRE, boss_wolf:SP_BOSS_WOLF, boss_hollow:SP_BOSS_HOLLOW, boss_emberlich:SP_BOSS_EMBERLICH,
  boss_maw:SP_BOSS_MAW, boss_golem:SP_BOSS_GOLEM, boss_sythiss:SP_BOSS_SYTHISS, boss_wraith:SP_BOSS_WRAITH,
  boss_skarn:SP_BOSS_SKARN, boss_devourer:SP_BOSS_DEVOURER, boss_frost:SP_BOSS_FROST, boss_brute:SP_BOSS_BRUTE,
  boss_faceless:SP_BOSS_FACELESS, boss_minotaur:SP_BOSS_MINOTAUR, boss_nightmother:SP_BOSS_NIGHTMOTHER, boss_warden:SP_BOSS_WARDEN,
  // Act II bosses — 20 named, ending on Zarakhel
  boss_vexa:SP_BOSS_VEXA, boss_korrun:SP_BOSS_KORRUN, boss_yshara:SP_BOSS_YSHARA,
  boss_helgrim:SP_BOSS_HELGRIM, boss_ozmael:SP_BOSS_OZMAEL, boss_drust:SP_BOSS_DRUST, boss_sarn:SP_BOSS_SARN,
  boss_bairgh:SP_BOSS_BAIRGH, boss_nyssa:SP_BOSS_NYSSA, boss_verdant:SP_BOSS_VERDANT, boss_throk:SP_BOSS_THROK,
  boss_vaelin:SP_BOSS_VAELIN, boss_mura:SP_BOSS_MURA, boss_iskvar:SP_BOSS_ISKVAR, boss_khaazum:SP_BOSS_KHAAZUM,
  boss_marrow:SP_BOSS_MARROW, boss_volthus:SP_BOSS_VOLTHUS, boss_erevhal:SP_BOSS_EREVHAL,
  boss_hollowchoir:SP_BOSS_HOLLOWCHOIR, boss_zarakhel:SP_BOSS_ZARAKHEL,
  potion:SP_POTION, gold:SP_GOLD, weapon:SP_WEAPON, armor:SP_ARMOR, helm:SP_HELM, shield:SP_SHIELD, charm:SP_CHARM,
  arrow:SP_ARROW,
  poison:SP_POISON, burn:SP_BURN, bleed:SP_BLEED, regen:SP_REGEN, weaken:SP_WEAKEN,
};
...
const GEAR_GLYPH = { weapon:")", armor:"[", helmet:"^", shield:"0" };
const GEAR_COL   = { weapon:"#9ad0ff", armor:"#c0a060", helmet:"#d0b48a", shield:"#a8b0c0" };
const ARMOR_KINDS = ["armor","helmet","shield"];
const ALL_SLOTS   = ["weapon","armor","helmet","shield","charm"];
const GEAR_SLOTS  = ["weapon","armor","helmet","shield"];   // mergeable tiered gear (excludes charms)
...
function addStatus(ent,type,turns,amount){
...
function statusAtkMod(ent){       // total attack reduction from 'weaken'
...
function statusLabel(ent){        // short text for the UI, e.g. "Poison 3, Bleed 2"
...
function makeCharm(){ const c=CHARMS[ri(0,CHARMS.length-1)];
  return {kind:"charm", charmId:c.id, glyph:"¤", col:"#c77dff", name:c.name, value:60}; }
function charmDef(it){ return CHARMS.find(c=>c.id===it.charmId); }
...
// ---------- stats / gear / log ----------
function tierTable(kind){ return kind==="weapon" ? WEAPONS : ARMOR_TIERS[kind]; }
function gearBonus(it){
